                      ...
                      <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" value="{{ old('telephone') }}" class="form-control @error('telephone') is-invalid @enderror" id="telephoneField" name="telephone" placeholder="Enter Last Name">
                                @error('telephone')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="date" value="{{ old('date_of_birth') }}" class="form-control @error('date_of_birth') is-invalid @enderror" id="dobField" name="date_of_birth" placeholder="Enter Last Name">
                                @error('date_of_birth')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" value="{{ old('joining_date') }}" class="form-control @error('joining_date') is-invalid @enderror" id="joinField" name="joining_date" placeholder="Enter Last Name">
                                        @error('joining_date')
                                            <div class="invalid-feedback">
                                              {{ $message }}
                                            </div>
