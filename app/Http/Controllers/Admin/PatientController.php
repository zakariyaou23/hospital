...
class PatientController extends Controller
{
    ...
    public function create()
    {
        ...
        $infrastructures = DB::table('infrastructures')
            ->pluck('name','id')->toArray();
        return view('admin.patients.create', compact('subdivisions','infrastructures'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.patients.view',compact('user','patient'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.patients.edit',compact('user','patient','subdivisions'));
    }
